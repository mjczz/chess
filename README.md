# Attention
this repository forked from https://github.com/gochenzl/chess
and I modify it by support go module system

#简述
![Alt text](https://github.com/mjczz/chess/blob/master/doc/pic/architecture.png?raw=true)
